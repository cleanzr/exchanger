...
class ESCNBClustParams : public ClustParams {
private:
   boost::optional<GammaRV> n_prior_;
   boost::optional<BetaRV> p_prior_;
   double n_;
   double p_;
public:
   /**
    ...
    * @param clust_params a `RP` S4 object representing the instantiated cluster parameters
    * @param clust_prior a `RP` S4 object representing the priors over the cluster parameters
    * @return a ESCNBClustParams instance
    */
   ESCNBClustParams(const Rcpp::S4 &clust_params, const Rcpp::S4 &clust_prior);
...
class ESCDClustParams : public ClustParams {
protected:
   boost::optional<GammaRV> n_prior_;
   boost::optional<BetaRV> p_prior_;
   double n_;
...
public:
    ...
    * @param clust_params a `RP` S4 object representing the instantiated cluster parameters
    * @param clust_prior a `RP` S4 object representing the priors over the cluster parameters
    * @return a ESCDClustParams instance
    */
   ESCDClustParams(const Rcpp::S4 &clust_params, const Rcpp::S4 &clust_prior);
...
public:
   ...
   * @param clust_params a `RP` S4 object representing the instantiated cluster parameters
   * @param clust_prior a `RP` S4 object representing the priors over the cluster parameters
   * @return a NBDClustParams instance
   */
  NBDClustParams(const Rcpp::S4 &clust_params, const Rcpp::S4 &clust_prior);
